...
int PQCLEAN_ROUND5{{ scheme|upper }}_round5_dem(unsigned char *c2, unsigned long long *c2_len, const unsigned char *key, const unsigned char *m, const unsigned long long m_len) {
    int result = 1;
    int len;
    int c2length;
    ...
    PQCLEAN_ROUND5{{ scheme|upper }}_hash(final_key_iv, (size_t) (PARAMS_KAPPA_BYTES + 12), key, PARAMS_KAPPA_BYTES, PARAMS_KAPPA_BYTES);
...
int PQCLEAN_ROUND5{{ scheme|upper }}_round5_dem_inverse(unsigned char *m, unsigned long long *m_len, const unsigned char *key, const unsigned char *c2, const unsigned long long c2_len) {
    int result = 1;
    int len;
    int m_length;
    EVP_CIPHER_CTX *ctx = NULL;
