 ...
 */
<<<<<<< HEAD
#define PQCLEAN_ROUND5R5ND_3KEM_0D_constant_time_shift_1_left64(out, shift_amount, flag) do { \
=======
 ...
 */
<<<<<<< HEAD
#define PQCLEAN_ROUND5R5ND_3KEM_0D_constant_time_shift_1_left64(out, shift_amount, flag) out = (1llu << (shift_amount))
=======
...
<<<<<<< HEAD
int PQCLEAN_ROUND5R5ND_3KEM_0D_probe_cm_odd(uint64_t *vplus, const uint16_t x) {
=======
...
<<<<<<< HEAD
    PQCLEAN_ROUND5R5ND_3KEM_0D_constant_time_shift_1_left64(y, x & 0x3F, 1); // low bits of index
    PQCLEAN_ROUND5R5ND_3KEM_0D_constant_time_shift_1_left64(z, x >> 6, 0); // high bits of index
=======
...
<<<<<<< HEAD
int PQCLEAN_ROUND5R5ND_3KEM_0D_probe_cm_even(uint64_t *vplus, const uint16_t x) {
=======
...
<<<<<<< HEAD
int PQCLEAN_ROUND5R5ND_3KEM_0D_probe_cm(uint64_t *v, const uint16_t x) {
=======
